...
const navigation = [
  ...
  { name: "Nos Programmes", href: "/programmes" },
  {
    ...
    children: [
      ...
      { name: "Activité Para-Étudiante", href: "/activites" },
      { name: "Galerie", href: "/galerie" },
    ],
  },
  { name: "Recherche Académique", href: "/recherche" },
            ...
            {navigation.map((item) =>
              item.children ? (
                ...
                >
                  ...
                  {dropdownOpen && (
                    <div className="absolute top-full left-0 bg-card rounded-lg shadow-xl border border-border py-2 min-w-48 animate-fade-in">
                  ...
                  <div key={item.name} className="space-y-1">
                    ...
                    {item.children.map((child) => (
                      <Link
                        key={child.name}
                        to={child.href}
                        className="block px-8 py-2 text-sm text-foreground hover:bg-accent rounded-lg"
